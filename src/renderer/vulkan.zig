...
pub const VulkanRenderer = struct {
    ...
    fn createGraphicsPipeline(self: *Self) !void {
        ...
        // Load shaders
        const vert_shader = try shader.loadFromFile(@ptrCast(?*vk.VkDevice_T, self.device), "shaders/triangle.vert");
        defer vert_shader.deinit();
        const frag_shader = try shader.loadFromFile(@ptrCast(?*vk.VkDevice_T, self.device), "shaders/triangle.frag");
