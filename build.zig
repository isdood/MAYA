...
fn createBuildOptionsModule(b: *std.Build, options: BuildOptions) *std.Build.Module {
    ...
    // Generate build_options.zig from the template
    const build_options_zig = b.addWriteFiles().add("build_options.zig", 
        \//! Build-time configuration options for the MAYA project
        \//! This file is auto-generated by the build system
        \
        \/// Whether profiling is enabled
        \pub const enable_profiling = {0};
        \
        \/// Whether GPU support is enabled
        \pub const enable_gpu = {1};
    , .{
    ...
    const build_options_module = b.createModule(.{
        .root_source_file = build_options_zig.getFileSource("build_options.zig"),
    });
