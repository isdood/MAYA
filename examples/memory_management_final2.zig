// This is a simplified version of the memory management example that uses the Vulkan C API directly
// and fixes the mutable variable issues in the original code.
...
test "memory management example" {
    ...
    _ = @import("memory_management_final2.zig");
}
