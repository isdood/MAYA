...
const FnVkEnumeratePhysicalDevices = fn (instance: VkInstance, pPhysicalDeviceCount: *u32, pPhysicalDevices: ?[*]VkPhysicalDevice) callconv(.C) VkResult;
const FnVkGetPhysicalDeviceProperties = fn (physicalDevice: VkPhysicalDevice, pProperties: *c.VkPhysicalDeviceProperties) callconv(.C) void;
const FnVkGetPhysicalDeviceQueueFamilyProperties = fn (physicalDevice: VkPhysicalDevice, pQueueFamilyPropertyCount: *u32, pQueueFamilyProperties: ?[*]c.VkQueueFamilyProperties) callconv(.C) void;
const FnVkCreateDevice = fn (physicalDevice: VkPhysicalDevice, pCreateInfo: *const c.VkDeviceCreateInfo, pAllocator: ?*const anyopaque, pDevice: *VkDevice) callconv(.C) VkResult;
const FnVkDestroyDevice = fn (device: VkDevice, pAllocator: ?*const anyopaque) callconv(.C) void;
const FnVkGetDeviceQueue = fn (device: VkDevice, queueFamilyIndex: u32, queueIndex: u32, pQueue: *c.VkQueue) callconv(.C) void;
const FnVkCreateBuffer = fn (device: VkDevice, pCreateInfo: *const c.VkBufferCreateInfo, pAllocator: ?*const anyopaque, pBuffer: *VkBuffer) callconv(.C) VkResult;
const FnVkDestroyBuffer = fn (device: VkDevice, buffer: VkBuffer, pAllocator: ?*const anyopaque) callconv(.C) void;
const FnVkGetBufferMemoryRequirements = fn (device: VkDevice, buffer: VkBuffer, pMemoryRequirements: *VkMemoryRequirements) callconv(.C) void;
const FnVkGetPhysicalDeviceMemoryProperties = fn (physicalDevice: VkPhysicalDevice, pMemoryProperties: *VkPhysicalDeviceMemoryProperties) callconv(.C) void;
const FnVkAllocateMemory = fn (device: VkDevice, pAllocateInfo: *const c.VkMemoryAllocateInfo, pAllocator: ?*const anyopaque, pMemory: *VkDeviceMemory) callconv(.C) VkResult;
const FnVkFreeMemory = fn (device: VkDevice, memory: VkDeviceMemory, pAllocator: ?*const anyopaque) callconv(.C) void;
const FnVkBindBufferMemory = fn (device: VkDevice, buffer: VkBuffer, memory: VkDeviceMemory, memoryOffset: c.VkDeviceSize) callconv(.C) VkResult;
const FnVkMapMemory = fn (device: VkDevice, memory: VkDeviceMemory, offset: c.VkDeviceSize, size: c.VkDeviceSize, flags: c.VkMemoryMapFlags, ppData: *?*anyopaque) callconv(.C) VkResult;
const FnVkUnmapMemory = fn (device: VkDevice, memory: VkDeviceMemory) callconv(.C) void;

const VulkanFunctions = struct {
    vkGetInstanceProcAddr: *const FnVkGetInstanceProcAddr,
    vkCreateInstance: *const FnVkCreateInstance,
    vkDestroyInstance: *const FnVkDestroyInstance,
    vkEnumeratePhysicalDevices: *const FnVkEnumeratePhysicalDevices,
    vkGetPhysicalDeviceProperties: *const FnVkGetPhysicalDeviceProperties,
    vkGetPhysicalDeviceQueueFamilyProperties: *const FnVkGetPhysicalDeviceQueueFamilyProperties,
    vkCreateDevice: *const FnVkCreateDevice,
    vkDestroyDevice: *const FnVkDestroyDevice,
    vkGetDeviceQueue: *const FnVkGetDeviceQueue,
    vkCreateBuffer: *const FnVkCreateBuffer,
    vkDestroyBuffer: *const FnVkDestroyBuffer,
    vkGetBufferMemoryRequirements: *const FnVkGetBufferMemoryRequirements,
    vkGetPhysicalDeviceMemoryProperties: *const FnVkGetPhysicalDeviceMemoryProperties,
    vkAllocateMemory: *const FnVkAllocateMemory,
    vkFreeMemory: *const FnVkFreeMemory,
    vkBindBufferMemory: *const FnVkBindBufferMemory,
    vkMapMemory: *const FnVkMapMemory,
    vkUnmapMemory: *const FnVkUnmapMemory,
};
...
const VulkanContext = struct {
    ...
    fn init() !@This() {
        ...
        const vkCreateInstance = try getProc(*const FnVkCreateInstance, "vkCreateInstance");
        ...
        const functions = VulkanFunctions{
            ...
            .vkDestroyInstance = try getProc(*const FnVkDestroyInstance, "vkDestroyInstance"),
            .vkEnumeratePhysicalDevices = try getProc(*const FnVkEnumeratePhysicalDevices, "vkEnumeratePhysicalDevices"),
            .vkGetPhysicalDeviceProperties = try getProc(*const FnVkGetPhysicalDeviceProperties, "vkGetPhysicalDeviceProperties"),
            .vkGetPhysicalDeviceQueueFamilyProperties = try getProc(*const FnVkGetPhysicalDeviceQueueFamilyProperties, "vkGetPhysicalDeviceQueueFamilyProperties"),
            .vkCreateDevice = try getProc(*const FnVkCreateDevice, "vkCreateDevice"),
            .vkDestroyDevice = try getProc(*const FnVkDestroyDevice, "vkDestroyDevice"),
            .vkGetDeviceQueue = try getProc(*const FnVkGetDeviceQueue, "vkGetDeviceQueue"),
            .vkCreateBuffer = try getProc(*const FnVkCreateBuffer, "vkCreateBuffer"),
            .vkDestroyBuffer = try getProc(*const FnVkDestroyBuffer, "vkDestroyBuffer"),
            .vkGetBufferMemoryRequirements = try getProc(*const FnVkGetBufferMemoryRequirements, "vkGetBufferMemoryRequirements"),
            .vkGetPhysicalDeviceMemoryProperties = try getProc(*const FnVkGetPhysicalDeviceMemoryProperties, "vkGetPhysicalDeviceMemoryProperties"),
            .vkAllocateMemory = try getProc(*const FnVkAllocateMemory, "vkAllocateMemory"),
            .vkFreeMemory = try getProc(*const FnVkFreeMemory, "vkFreeMemory"),
            .vkBindBufferMemory = try getProc(*const FnVkBindBufferMemory, "vkBindBufferMemory"),
            .vkMapMemory = try getProc(*const FnVkMapMemory, "vkMapMemory"),
            .vkUnmapMemory = try getProc(*const FnVkUnmapMemory, "vkUnmapMemory"),
        };
